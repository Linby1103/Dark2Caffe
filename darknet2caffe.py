import sys
from cfg import *
sys.path.append('/home/workspace/install/caffe_install/caffe-master/python')
...
# python darknet2caffe.py cfg/yolov3.cfg weights/yolov3.weights prototxt/yolov3.prototxt caffemodel/yolov4.caffemodel
if __name__ == '__main__':
    import sys

    cfgfile = '/home/workspace/nnie/package/yolov3/darknet2caffe-master/cfg/yolov3.cfg'
    weightfile = '/home/workspace/nnie/package/yolov3/darknet2caffe-master/weights/yolov3.weights'

    protofile = '/home/workspace/nnie/package/yolov3/darknet2caffe-master/prototxt/yolov3.prototxt'

    #python  yolov3_darknet2caffe.py yolov3xxx.cfg yolov3xxx.weight  xxx.prototxt xxx.caffemodel

    caffemodel = '/home/workspace/nnie/package/yolov3/darknet2caffe-master/caffemodel/yolov3.caffemodel'
